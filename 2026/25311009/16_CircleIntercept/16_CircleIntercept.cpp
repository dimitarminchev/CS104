// 16_CircleIntercept.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	else if (d == Ar + Br) cout << "Circles have ONE common point of intercept";
	else if (d < Ar + Br) cout << "Circles have TWO common points of intercept";
	return 0;
}
